DWS – Backend Challenge: Albums API - Albums service

This is the test project for the DWS – Dentsu World Services recruitment process. The application is a Spring Boot backend that consumes data from an external albums API, exposes REST endpoints, and applies caching for performance optimization.
...
- Returns all albums fetched from the external API.
- Example response:

[
    {
		"id": "3c5794a0-d913-390d-ab24-6762af38c112",
		"name": "Silver Side Up",
		"releasedDate": "1988-10-07T10:34:21.08",
		"band": {
	...
	{
		"id": "31e609d2-49aa-4b71-ad6e-57c0b0f54161",
		"name": "Dizzy Up the Girl",
		"releasedDate": "1999-01-15T22:44:26.54",
		"band": {
...
- Applied to both the list and individual album endpoints.
...
It includes success and error response examples, including invalid ID and album not found messages.
...
2. Run: `docker run -p 8090:8090 --name albums ohnilovec/albums/v1`
...
`git clone https://github.com/SyrusAmadeu/albums`
`cd albums`
...
GET http://localhost:8090/api/albums
GET http://localhost:8090/api/albums/{id}
...
- Fetching all albums
- Fetching an existing album
- Fetching a non-existing album (throws AlbumNotFoundException)
